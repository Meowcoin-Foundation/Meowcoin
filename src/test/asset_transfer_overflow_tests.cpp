// Copyright (c) 2026-present The Meowcoin Core developers
...
// behavior may be affected (see AvianNetwork/Avian PR #251, same defect
// class, fixed in their v5.0.4/v4.2.1).
//
...
// exercised by transactions built directly against CheckTxAssets below.
...
// ChainType::MAIN, whose activation height is 2,085,000.
