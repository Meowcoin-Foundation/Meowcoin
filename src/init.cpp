...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    // AuxPow: Allow switching of default pow algo (meowpow) via conf / command line, for miners that can't easily adjust their getblocktemplate calls
    strUsage += HelpMessageOpt("-powalgo=meowpow|scrypt", strprintf(_("Default pow mining algorithm. Miners who can't easily adjust their getblocktemplate calls should use this argument to set their preferred mining algorithm. (default: %s)"), DEFAULT_POW_TYPE));
...
/** Sanity checks
 *  Ensure that Meowcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Meowcoin process is using the data directory.
